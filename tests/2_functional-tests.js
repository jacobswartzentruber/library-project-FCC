    ...
    suite('POST /api/books with title => create book object/expect book object', function() {
      ...
      test('Test POST /api/books with title', function(done) {
        chai
          ...
          .end(function(err, res){
            ...
            assert.equal(res.body.title, "New Title", 'Book should contain title submitted');
            done();
          });
      });
      ...
      test('Test POST /api/books with no title given', function(done) {
        chai
          ...
          .end(function(err, res){
            assert.equal(res.status, 200);
            assert.equal(res.text, 'missing required field title', 'Error should be "missing required field title"');
            done();
          });
      });
    });
      ...
      test('Test POST /api/books/[id] with comment', function(done){
        chai
          ...
          .end(function(err, res) {
            ...
            assert.property(res.body, 'title', 'Book should contain title');
            assert.property(res.body, '_id', 'Book should contain _id');
            assert.include(res.body.comments, 'Test Comment', 'Book should contain new comment in comment array');
            done();
          });
      });
